...
require(ibmdbR) # IBM R package for in db analytics
require(ggmap) # google map api
require(ggplot2) # grammar of graphics plots pakage
...
pallette <- colorRampPalette(c('white','magenta'))
